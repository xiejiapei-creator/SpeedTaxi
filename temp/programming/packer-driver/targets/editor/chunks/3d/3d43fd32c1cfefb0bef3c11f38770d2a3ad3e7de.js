    ...
    execute: function () {
      ...
      _export("signIn", signIn = (_dec = ccclass("signIn"), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(Sprite), _dec7 = property(SpriteFrame), _dec8 = property(SpriteFrame), _dec9 = property(SpriteFrame), _dec10 = property(SpriteFrame), _dec11 = property(Node), _dec12 = property(Prefab), _dec(_class = (_class2 = class signIn extends Component {
        ...
        setButtonStyle() {
          ...
          let arrSignIn = (_crd && localConfig === void 0 ? (_reportPossibleCrUseOflocalConfig({
            error: Error()
        ...
        showSignInInfo() {
          ...
          for (let idx = 0; idx < arrSignIn.length; idx++) {
            ...
            let signInItemScript = signInItemNode.getComponent(_crd && signInItem === void 0 ? (_reportPossibleCrUseOfsignInItem({
              error: Error()
        ...
        receiveReward(itemInfo, isDouble, callback) {
          ...
          let title = (_crd && i18n === void 0 ? (_reportPossibleCrUseOfi18n({
            error: Error()
          }), i18n) : i18n).t("showReward.signinReward");
          let targetItemInfo = (_crd && util === void 0 ? (_reportPossibleCrUseOfutil({
            error: Error()
          ...
          if (itemInfo.ID == 2 || itemInfo.ID == 7) {
            ...
            let isHadCar = (_crd && playerData === void 0 ? (_reportPossibleCrUseOfplayerData({
              error: Error()
...
//# sourceMappingURL=3d43fd32c1cfefb0bef3c11f38770d2a3ad3e7de.js.map