  ...
  return {
    ...
    execute: function () {
      ...
      _export("playerData", playerData = (_dec = ccclass("playerData"), _dec(_class = (_class2 = class playerData extends Component {
        ...
        loadGlobalCache() {
          let userId = (_crd && configuration === void 0 ? (_reportPossibleCrUseOfconfiguration({
            error: Error()
        ...
        loadDataByKey(keyName) {
          let ret = {};
          let str = (_crd && configuration === void 0 ? (_reportPossibleCrUseOfconfiguration({
            error: Error()
        ...
        updateSignInCurrentDay() {
          if (Object.keys(this.playerInfo.signInInfo).length === 0 || this.isNeedRecycleSignInInfo()) {
            ...
            let offectDays = (_crd && util === void 0 ? (_reportPossibleCrUseOfutil({
              error: Error()
        ...
        */
        ...
        isNeedRecycleSignInInfo() {
          ...
          let diffTime = (_crd && util === void 0 ? (_reportPossibleCrUseOfutil({
            error: Error()
...
//# sourceMappingURL=728f11acf9e4a9481e4de327812cd2c861799159.js.map