    ...
    execute: function () {
      ...
      _export("gameLogic", gameLogic = (_dec = ccclass("gameLogic"), _dec(_class = (_class2 = class gameLogic {
        ...
        static isVibrateOpen() {
          let isVibrateOpen = (_crd && configuration === void 0 ? (_reportPossibleCrUseOfconfiguration({
            error: Error()
        ...
        static showFlyReward(rewardType, callback) {
          (_crd && resourceUtil === void 0 ? (_reportPossibleCrUseOfresourceUtil({
            ...
            let reward = node.getComponent(_crd && flyReward === void 0 ? (_reportPossibleCrUseOfflyReward({
              error: Error()
...
//# sourceMappingURL=0cb713329a633010d7adba7f992c1c9a6c3c0bf7.js.map