  ...
  return {
    ...
    execute: function () {
      ...
      _export("shop", shop = (_dec = ccclass("shop"), _dec2 = property(Label), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(Node), _dec7 = property(Label), _dec8 = property(Label), _dec9 = property(Label), _dec10 = property(Node), _dec11 = property(Node), _dec12 = property(Prefab), _dec13 = property(Sprite), _dec14 = property(Label), _dec(_class = (_class2 = class shop extends Component {
        ...
        show() {
          var cars = (_crd && localConfig === void 0 ? (_reportPossibleCrUseOflocalConfig({
            error: Error()
        ...
        updateGold() {
          var gold = (_crd && playerData === void 0 ? (_reportPossibleCrUseOfplayerData({
            error: Error()
        ...
        onBtnGetClick() {
          ...
          if ((_crd && playerData === void 0 ? (_reportPossibleCrUseOfplayerData({
            ...
            var currentProgress = (_crd && playerData === void 0 ? (_reportPossibleCrUseOfplayerData({
              error: Error()
        ...
        onShopItemSelect(carID, useCar) {
          var curPage = this.currentPage.getComponent(_crd && shopPage === void 0 ? (_reportPossibleCrUseOfshopPage({
            error: Error()
          }), shopPage) : shopPage);
          curPage.unSelectAll();
        ...
        updateButtons() {
          if ((_crd && playerData === void 0 ? (_reportPossibleCrUseOfplayerData({
            ...
            this.nodeGo.active = true;
            this.nodeBuy.active = false;
            var num = (_crd && playerData === void 0 ? (_reportPossibleCrUseOfplayerData({
              error: Error()
            }), playerData) : playerData).instance.getBuyTypeProgress(this.currentCarInfo.type);
            ...
            var strDesc = (_crd && i18n === void 0 ? (_reportPossibleCrUseOfi18n({
              error: Error()
        ...
        onBtnLeftClick() {
          var shopPageScript = this.currentPage.getComponent(_crd && shopPage === void 0 ? (_reportPossibleCrUseOfshopPage({
            error: Error()
          }), shopPage) : shopPage);
...
//# sourceMappingURL=0e359915d22eeb071d3b1bc597b1310940c6dc76.js.map