      ...
      _export("lottery", lottery = (_dec = ccclass("lottery"), _dec2 = property(Node), _dec3 = property(Prefab), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(Button), _dec7 = property(Button), _dec8 = property(Label), _dec9 = property(SpriteFrame), _dec10 = property(SpriteFrame), _dec11 = property(SpriteFrame), _dec12 = property(Sprite), _dec13 = property(Sprite), _dec14 = property(Sprite), _dec(_class = (_class2 = class lottery extends Component {
        ...
        initReward() {
          ...
          if (arrLottery.length < 6) {
            //不足6辆，从已有的车辆中获得
            var arrHas = (_crd && lodash === void 0 ? (_reportPossibleCrUseOflodash({
              error: Error()
            ...
            while (arrLottery.length < 6) {
              ...
              var car = (_crd && localConfig === void 0 ? (_reportPossibleCrUseOflocalConfig({
                error: Error()
          ...
          for (var idx = 0; idx < this.arrRewardNode.length; idx++) {
            ...
            if (this.arrRewardData.length > idx) {
              ...
              var script = rewardItem.getComponent(_crd && lotteryItem === void 0 ? (_reportPossibleCrUseOflotteryItem({
                error: Error()
        ...
        checkIsFree() {
          ...
          var data = (_crd && configuration === void 0 ? (_reportPossibleCrUseOfconfiguration({
            error: Error()
        ...
        showReward() {
          ...
          var lottery = itemNode.getComponent(_crd && lotteryItem === void 0 ? (_reportPossibleCrUseOflotteryItem({
            error: Error()
          }), lotteryItem) : lotteryItem);
...
//# sourceMappingURL=138fc34468f4e7f72202aaa85c68bf0f832e619e.js.map