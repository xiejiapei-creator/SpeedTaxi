    ...
    execute: function () {
      ...
      _export("mainUI", mainUI = (_dec = ccclass("mainUI"), _dec2 = property(Sprite), _dec3 = property(Label), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(Node), _dec7 = property(Node), _dec(_class = (_class2 = class mainUI extends Component {
        ...
        updateSignIn() {
          ...
          var signInStatus = (_crd && playerData === void 0 ? (_reportPossibleCrUseOfplayerData({
            error: Error()
        ...
        show() {
          ...
          var arr = (_crd && playerData === void 0 ? (_reportPossibleCrUseOfplayerData({
            error: Error()
...
//# sourceMappingURL=c9783359e65b51d33953497b4864af01c012bf19.js.map