    ...
    execute: function () {
      ...
      _export("fightMap", fightMap = (_dec = ccclass("fightMap"), _dec2 = property({
          ...
          (_crd && resourceUtil === void 0 ? (_reportPossibleCrUseOfresourceUtil({
            ...
            for (var _idx2 = 0; _idx2 < objPlane.children.length; _idx2++) {
              ...
              var node = (_crd && poolManager === void 0 ? (_reportPossibleCrUseOfpoolManager({
                error: Error()
              }), poolManager) : poolManager).instance.getNode(_prefab, nodeParent);
        ...
        createRoadPoint(objPoint, parent) {
          ...
          var point = nodeRoadPoint.addComponent(_crd && roadPoint === void 0 ? (_reportPossibleCrUseOfroadPoint({
            error: Error()
          }), roadPoint) : roadPoint);
...
//# sourceMappingURL=6e65647312bfaa99ea78c9b813254291200346b2.js.map