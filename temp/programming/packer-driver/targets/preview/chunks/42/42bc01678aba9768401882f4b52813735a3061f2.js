    ...
    execute: function () {
      ...
      _export("online", online = (_dec = ccclass("online"), _dec2 = property(Sprite), _dec3 = property(Sprite), _dec4 = property(Label), _dec(_class = (_class2 = class online extends Component {
        ...
        refresh() {
          ...
          var lastTime = (_crd && playerData === void 0 ? (_reportPossibleCrUseOfplayerData({
            error: Error()
          }), playerData) : playerData).instance.getLastOnlineRewardTime();
          var offsetTime = Math.floor(((_crd && playerData === void 0 ? (_reportPossibleCrUseOfplayerData({
            error: Error()
          ...
          var percent = offsetTime / (_crd && constant === void 0 ? (_reportPossibleCrUseOfconstant({
            error: Error()
          }), constant) : constant).ONLINE.MAX_TIME;
        ...
        update(deltaTime) {
          ...
          if (!this.isOverflow) {
            ...
            if (this.currentTime > (_crd && constant === void 0 ? (_reportPossibleCrUseOfconstant({
              ...
              var progress = this.currentTime / (_crd && constant === void 0 ? (_reportPossibleCrUseOfconstant({
                error: Error()
              }), constant) : constant).ONLINE.TIME_PER_CIRCLE;
...
//# sourceMappingURL=42bc01678aba9768401882f4b52813735a3061f2.js.map